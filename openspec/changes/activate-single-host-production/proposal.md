...
| Field | Declaration |
|---|---|
| Status | Partially applied: source `be48847bc26bcda28c9f08f6807f5dec40d479f4` is healthy and private, the exact legacy loader is stopped, and updater run `6d7dd3d4-9eb4-472e-af09-0561dc313617` failed safely without publication. Exact-head operations source `1505c5d7c36f457ed8d9e3be542e2422fe2811fc` is admitted after run `30452886753` is fully green; one Compose-file transaction and one new updater invocation are authorized only after this amendment is committed and pushed. |
