...
- Update the project-owned skill and Codex hook with official CLI
  `impeccable@3.3.1`, accepting only Skill v4.0.2 from tag `skill-v4.0.2`
...
| Acceptance | Official updater is idempotent under Node 24; installed tree identifies v4.0.2 and matches the pinned official tag; context/surface/doctor/hook/syntax/OpenSpec/Git checks pass; only declared paths change; no transient residue remains. |
