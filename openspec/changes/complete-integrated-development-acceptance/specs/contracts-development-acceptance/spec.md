...
`openapi-typescript@7.13.0` commands against the shared OpenAPI authority to
create `.tmp/query-a.d.ts` and `.tmp/query-b.d.ts`. Only after those four
...
cleanup command. It SHALL NOT skip either TypeScript generation, feed a
generated bundle to TypeScript, duplicate the Go generator outside the
verifier, or clean generated bytes before their verification.
