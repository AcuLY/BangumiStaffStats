...
| Writable paths | `VERSION`; `contracts/goldens/api/catalog/{verify.mjs,generation.json,index.json}`; `contracts/schemas/archive/**`; `contracts/goldens/archive/**`; `contracts/artifacts/**`; `contracts/producer-runtime-inputs-v1.json`; `backend/internal/archive/**`; `backend/internal/releaseinfo/**`; `backend/cmd/api/**`; `backend/cmd/archive-smoke/**`; `backend/build/**`; `updater/src/bangumi_staff_stats_updater/{archive_contract.py,producer/**}`; `updater/tests/**`; `updater/build/**`; `frontend/build/**`; and this change's OpenSpec lifecycle paths. |
