...
| Writable paths | `frontend/src/api/candidates.ts`, `frontend/src/api/partners.ts`, `frontend/src/api/coStar.ts`, `frontend/src/api/adapters/candidates.ts`, `frontend/src/api/adapters/partners.ts`, `frontend/src/api/adapters/coStar.ts`, the narrowly scoped read-only error-response metadata extension in `frontend/src/api/client.ts`, `frontend/src/features/co-star/**`, `frontend/src/features/query/coordinator.ts`, `frontend/src/features/query/share.ts`, `frontend/src/features/query/components/AppHeader.vue`, `frontend/src/features/query/components/QueryWorkspace.vue`, `frontend/src/features/person-detail/ratingTimelineGeometry.ts`, `frontend/src/app/App.vue`, `frontend/src/app/routes.ts`, `frontend/src/shared/charts/**`, `frontend/src/shared/components/AppIcon.vue`, `frontend/src/shared/components/SafeImage.vue`, `frontend/src/shared/media/bangumiImage.ts`, `frontend/src/shared/styles/base.css`, `frontend/scripts/check-architecture.mjs`, `frontend/scripts/check-production-artifact.mjs`, `frontend/tests/api/candidates.test.ts`, `frontend/tests/api/partners.test.ts`, `frontend/tests/api/co-star.test.ts`, `frontend/tests/api/client.test.ts`, `frontend/tests/features/co-star/**`, `frontend/tests/features/query/coordinator.test.ts`, `frontend/tests/features/query/share-routes.test.ts`, `frontend/tests/features/query/components.test.ts`, `frontend/tests/app/app.mount.test.ts`, `frontend/tests/app/co-star.integration.test.ts`, `frontend/tests/shared/SafeImage.test.ts`, and this change's task markers. |
