...
|---|---|
| Status | Investigated/specified/main-agent reviewed: complete; implemented/verified/committed/pushed/released/deployed: no. Group 1 may apply after its dependency/ownership preflight; later groups retain their explicit handoff gates. |
