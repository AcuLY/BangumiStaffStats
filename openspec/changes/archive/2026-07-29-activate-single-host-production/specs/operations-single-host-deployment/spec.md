...
| Field | Declaration |
|---|---|
| Status | Completed on `myserver`: exact operations source `1505c5d7c36f457ed8d9e3be542e2422fe2811fc` is installed; updater run `6eb4dd5e-c921-4251-b189-0ae522343219` published the first real Archive; host integration, public cutover, and one rollback/forward drill passed; legacy serving remains available with its loader intentionally stopped. |
