...
| Field | Declaration |
|---|---|
| Status | Frontend/path-split implementation, exact-head Actions and bundle admission, transactional deployment, same-vhost production cutover, rollback verification, and public acceptance complete; specification archive and lifecycle push pending. |
