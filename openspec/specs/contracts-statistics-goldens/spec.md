# contracts-statistics-goldens Specification

## Purpose
Define the closed, language-neutral oracle corpus for exact ratings, series,
preference evidence, summaries, and strict sort orders.
