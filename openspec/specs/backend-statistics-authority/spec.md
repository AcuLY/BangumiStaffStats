# backend-statistics-authority Specification

## Purpose
Define the Backend's immutable, exact-arithmetic authority for statistical
units, series, ratings, preference, evidence, summaries, and total ordering.
