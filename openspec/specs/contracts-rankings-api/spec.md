# contracts-rankings-api Specification

## Purpose
Define the closed versioned rankings request, response, error, golden, and
isolated code-generation contract shared by backend and frontend.
## Requirements
