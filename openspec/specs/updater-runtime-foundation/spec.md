# updater-runtime-foundation Specification

## Purpose
Define the pinned installable Python package and terminating CLI, together with
the strict read-only Archive contract adapter and quality gates required before
immutable Archive production is introduced.
## Requirements
