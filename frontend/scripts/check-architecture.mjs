...
const expectedInventory = [
  ...
  'tests/app/person-entry-routes.test.ts',
  'tests/app/person-entry.integration.test.ts',
  ...
  'tests/features/query/store-unrestricted.test.ts',
  ...
  'tests/shared/separators.test.ts',
